...
const staticPostsDirectory = path__WEBPACK_IMPORTED_MODULE_4___default().join(process.cwd(), 'pages/content');
async function getStaticProps() {
    const filePath = path__WEBPACK_IMPORTED_MODULE_4___default().join(staticPostsDirectory, `resume.md`);
    const resumeData = await (0,_lib_posts__WEBPACK_IMPORTED_MODULE_3__/* .getMdData */ .GH)(filePath);
    return {
        props: {
            resumeData
        }
...
var __webpack_exports__ = __webpack_require__.X(0, [730,61,469,904], () => (__webpack_exec__(3175)));
